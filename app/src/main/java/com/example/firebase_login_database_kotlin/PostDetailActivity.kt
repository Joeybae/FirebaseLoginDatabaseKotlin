...
import com.example.firebase_login_database_kotlin.users.Comment
        ...
        val postListener = object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                post?.let {
                    ...
                    postDate.text = it.date
                    postBody.text = it.body
                }
                //image
                val mIMAGEView = findViewById<ImageView>(R.id.postImage)
                val mThread = object : Thread() {
                    override fun run() {
                        ...
                        } catch (ee: MalformedURLException) {
                            ee.printStackTrace()
                        } catch (e: IOException) {
                            e.printStackTrace()
                        }
